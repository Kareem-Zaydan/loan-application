...
const CurrencyInput = forwardRef(function CurrencyInput(
    ...
    const [displayValue, setDisplayValue] = useState(
        formatIndianCurrency(defaultValue),
    );
        ...
        <div className={`space-y-2 ${className}`}>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className={`min-h-11 w-full rounded-xl border bg-white py-2 pl-9 pr-4 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/10 ${
                        error
                            ? 'border-error'
                            : 'border-slate-300'
                    }`}
